                            ...
                            <form action="{{ route('admin.staff-account-management.memberships.update', $data->id) }}" method="POST" enctype="multipart/form-data" id="main-form">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-10 col-sm-12">
                                        <textarea class="form-control" id="description" name="description" rows="3" placeholder="Provide membership details">{{ $data->description }}</textarea>
                                    </div>
                                </div>   
                                <!--<div class="mb-3 row">-->
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-10 col-sm-12 d-flex align-items-center">
                                        <input type="number" min="0" class="form-control" id="month" name="month" value="{{ old('month', $data->month ?? '0') }}"/>
                                    </div>
                                </div>       
                                <div class="mb-3 row">
                                    <label for="day" class="col-sm-12 col-lg-2 col-form-label">Day: </label>
                                    <div class="col-lg-10 col-sm-12 d-flex align-items-center">
                                        <input type="number" min="0" class="form-control" id="day" name="day" value="{{ old('day', $data->day ?? '0') }}"/>
                                    </div>
                                </div>
                                <div class="mb-3 row">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 border-0 shadow">
                <div class="modal-header border-0 pb-0">
                    <h5 class="modal-title fw-semibold" id="formConfirmModalLabel">Update membership?</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p class="text-muted mb-3">Confirm these details before saving changes.</p>
