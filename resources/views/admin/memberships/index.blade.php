                                                    ...
                                                    <div class="modal-content border-0 shadow rounded-4">
                                                        <div class="modal-header border-0 pb-0">
                                                            <div class="d-flex align-items-center gap-3">
                                                                ...
                                                                <div>
                                                                    <p class="text-uppercase text-muted small mb-1">Archive membership</p>
                ...
                <div class="box mt-5">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card-footer bg-white border-0 d-flex justify-content-between align-items-center flex-wrap gap-2">
                                <div class="text-muted small">
                                    Showing {{ $archivedData->firstItem() ?? 0 }} to {{ $archivedData->lastItem() ?? 0 }} of {{ $archivedData->total() }} archived memberships
                                </div>
                                <div class="ms-auto">
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    function buildRows(items) {
                        ...
                        return items.map((item) => ([
                            ...
                            `<div style="text-align: right;"><div>₱${formatPlanPrice(item.price)}</div><div class="muted">Plan length: ${item.month || '0'} mo., ${item.day || '0'} day(s).</div><div class="muted">Classes/mo: ${item.classes_per_month !== null && item.classes_per_month !== undefined && item.classes_per_month !== '' ? item.classes_per_month : 'Unlimited'}</div></div>`,
