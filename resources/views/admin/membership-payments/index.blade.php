                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card-footer bg-white border-0 d-flex justify-content-between align-items-center flex-wrap gap-2">
                                <div class="text-muted small">
                                    Showing {{ $activeMemberships->firstItem() ?? 0 }} to {{ $activeMemberships->lastItem() ?? 0 }} of {{ $activeMemberships->total() }} results
                                </div>
                                <div class="ms-auto">
                                    {{ $activeMemberships->links('pagination::bootstrap-5') }}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box mt-5">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card-footer bg-white border-0 d-flex justify-content-between align-items-center flex-wrap gap-2">
                                <div class="text-muted small">
                                    Showing {{ $archivedMemberships->firstItem() ?? 0 }} to {{ $archivedMemberships->lastItem() ?? 0 }} of {{ $archivedMemberships->total() }} archived payments
                                </div>
                                <div class="ms-auto">
                                    {{ $archivedMemberships->links('pagination::bootstrap-5') }}
                                </div>
                            </div>
                        </div>
                    </div>
