                        ...
                        <div class="receipt-hero d-flex justify-content-between align-items-center flex-wrap gap-3">
                            ...
                            <div class="text-end">
                                ...
                                <div class="small text-white-50">
                                    <span class="receipt-meta-strong">Issued</span>
                                    <span class="receipt-meta-strong">{{ $createdAt->format('F j, Y g:i A') }}</span>
                                </div>
                                <div class="small text-white-50">Generated by {{ $printGeneratedBy }}</div>
                            </div>
                        </div>
