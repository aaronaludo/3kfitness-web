        ...
        <div class="row">
            @php
                ...
                $mapStaff = function ($item) use ($nowForPrint, $employmentTypeLabel) {
                    ...
                    $grossPay = (float) ($item->rate_per_hour ?? 0) * $totalHours;
                    ...
                    $netPay = max($grossPay - ($sssEmployee + $philhealthEmployee + $pagibigEmployee), 0);
                                    ...
                                    <div class="flex-grow-1 flex-lg-grow-0" style="min-width: 240px;">
                                        <div class="position-relative">
                                            ...
                                            <input
                                                ...
                                                name="name"
                                                placeholder="Search staff by name, code, email, role"
                                                value="{{ request('name') }}"
                                                    ...
                                                    <div class="modal-content border-0 shadow rounded-4">
                                                        <div class="modal-header border-0 pb-0">
                                                            <div class="d-flex align-items-center gap-3">
                                                                ...
                                                                <div>
                                                                    <p class="text-uppercase text-muted small mb-1">Archive staff</p>
                                                        ...
                                                        <form action="{{ route('admin.staff-account-management.delete') }}" method="POST" id="main-form-{{ $item->id }}">
                                                            ...
                                                            <div class="modal-body pt-3">
                                                                <div class="alert alert-danger bg-opacity-10 text-danger border-0 rounded-3">
                                                                    Archiving will move this staff record to the archived list. You can restore it later if needed.
                                                                </div>
                ...
                <div class="box mt-5">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card-footer bg-white border-0 d-flex justify-content-between align-items-center flex-wrap gap-2">
                                <div class="text-muted small">
                                    Showing {{ $archivedData->firstItem() ?? 0 }} to {{ $archivedData->lastItem() ?? 0 }} of {{ $archivedData->total() }} archived staff
                                </div>
                                <div class="ms-auto">
